  ...
  const gaps = useMemo(
    () => (today && view
      ? campaignGaps({
          ...
          taskName: (view as any).task_name,
          brandName: (view as any).brand_name,
          categoryId: (view as any).client_category_id,
          hasCloser: !!closerKey(view as any),
          startDate: (view as any).package_start_date,
          endDate: (view as any).package_end_date,
          approval: (view as any).approval_stage,
          contractStatus: (view as any).contract_status,
          bookings,
          adsWithoutDate,
          overduePayments,
          stuckContracts,
