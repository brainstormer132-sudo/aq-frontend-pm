-- ============================================================
-- 109_ugc_template_v4.sql   GENERATED - do not hand-edit.
--   node scripts/build-legal-seed.mjs
--
-- Ports the live "Rawad altathir UGC" contract into legal.*: 16 typed
-- fields and 42 blocks as version 4, published, in workspace
...
begin
  ...
  select id into v_ver from legal.doc_template_version
   where template_id = v_tpl and version = 4;
  if v_ver is null then
    ...
    values (v_tpl, v_ws, 4, 'draft') returning id into v_ver;
    ...
    raise notice 'version 4 already exists - blocks left alone';
  end if;
