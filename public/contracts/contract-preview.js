...
(function (root) {
  ...
  function contractPreviewModel(input) {
    ...
    if (durationRow.missing) {
      // Not a default. The 60/90 template says "the transfer will be within
   ...
   *
   * `pending` marks the three the backend fills at generation time - the
   * contract number and the two dates. They are not gaps, and colouring
